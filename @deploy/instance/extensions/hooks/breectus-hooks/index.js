...
var require_lodash2 = __commonJS({
  "node_modules/.pnpm/lodash._stringtopath@4.8.0/node_modules/lodash._stringtopath/index.js"(exports, module2) {
    ...
    var stringToPath = memoize(function(string2) {
      var result = [];
      toString2(string2).replace(rePropName, function(match, number2, quote, string3) {
...
var require_lodash3 = __commonJS({
  "node_modules/.pnpm/lodash._baseiteratee@4.7.0/node_modules/lodash._baseiteratee/index.js"(exports, module2) {
    ...
    function arrayMap(array2, iteratee) {
      var index = -1, length = array2.length, result = Array(length);
      while (++index < length) {
    ...
    function baseHas(object2, key) {
      return hasOwnProperty.call(object2, key) || typeof object2 == "object" && key in object2 && getPrototype(object2) === null;
    }
    function baseHasIn(object2, key) {
      return key in Object(object2);
    }
    ...
    function baseKeys(object2) {
      return nativeKeys(Object(object2));
    }
    ...
    function equalByTag(object2, other, tag, equalFunc, customizer, bitmask, stack) {
      switch (tag) {
        ...
        case numberTag:
          return object2 != +object2 ? other != +other : object2 == +other;
        case regexpTag:
        case stringTag:
          return object2 == other + "";
        case mapTag:
        ...
        case setTag:
          ...
          return equalArrays(convert(object2), convert(other), equalFunc, customizer, bitmask, stack);
        case symbolTag:
          if (symbolValueOf) {
    ...
    function getMatchData(object2) {
      var result = toPairs(object2), length = result.length;
      while (length--) {
    ...
    function hasPath(object2, path, hasFunc) {
      ...
      return !!length && isLength(length) && isIndex(key, length) && (isArray(object2) || isString(object2) || isArguments(object2));
    }
    function indexKeys(object2) {
      var length = object2 ? object2.length : void 0;
      if (isLength(length) && (isArray(object2) || isString(object2) || isArguments(object2))) {
    ...
    function keys(object2) {
      ...
      if (!(isProto || isArrayLike(object2))) {
        return baseKeys(object2);
      }
      var indexes = indexKeys(object2), skipIndexes = !!indexes, result = indexes || [], length = result.length;
      for (var key in object2) {
        if (baseHas(object2, key) && !(skipIndexes && (key == "length" || isIndex(key, length))) && !(isProto && key == "constructor")) {
          result.push(key);
        }
      }
      return result;
...
var require_lodash6 = __commonJS({
  "node_modules/.pnpm/lodash._baseuniq@4.6.0/node_modules/lodash._baseuniq/index.js"(exports, module2) {
    ...
    function arrayIncludes(array2, value) {
      return !!array2.length && baseIndexOf(array2, value, 0) > -1;
    }
    ...
    function baseIndexOf(array2, value, fromIndex) {
      if (value !== value) {
        return indexOfNaN(array2, fromIndex);
      }
    ...
    function indexOfNaN(array2, fromIndex, fromRight) {
      var length = array2.length, index = fromIndex + (fromRight ? 0 : -1);
      while (fromRight ? index-- : ++index < length) {
        var other = array2[index];
        if (other !== other) {
          return index;
        }
      }
...
var require_lib2 = __commonJS({
  "node_modules/.pnpm/@breejs+later@4.1.0/node_modules/@breejs/later/lib/index.js"(exports, module2) {
    ...
    later.array = {};
    later.array.sort = function(array2, zeroIsLast) {
      array2.sort(function(a, b) {
        return Number(a) - Number(b);
      });
      if (zeroIsLast && array2[0] === 0) {
    ...
    later.compile = function(schedDef) {
      ...
      return {
        ...
        tick: function tick(dir, date2) {
          return new Date(dir === "next" ? tickConstraint.end(date2).getTime() + later.SEC : tickConstraint.start(date2).getTime() - later.SEC);
        },
        tickStart: function tickStart(date2) {
    ...
    later.schedule = function(sched) {
      ...
      function findNext(array2, compare) {
        var next = array2[0];
        for (var _i11 = 1, length = array2.length; _i11 < length; _i11++) {
          if (array2[_i11] && compare(next, array2[_i11])) {
            next = array2[_i11];
          }
        }
        return next;
    ...
    later.setTimeout = function(fn, sched, timezone) {
      ...
      function scheduleTimeout() {
        ...
        var next = function() {
          ...
          var localOffsetMillis = date2.getTimezoneOffset() * 6e4;
          var offsetMillis = getOffset(date2, timezone);
    ...
    later.parse.cron = function(expr, hasSeconds) {
      ...
      function cloneSchedule(sched) {
        ...
        for (field in sched) {
          if (field !== "dc" && field !== "d") {
            clone2[field] = sched[field].slice(0);
          }
        }
        return clone2;
      }
      ...
      return {
        ...
        time: function time() {
          for (var _i12 = 0, _values2 = values, length = _values2.length; _i12 < length; _i12++) {
            var split2 = values[_i12].split(":");
            if (split2.length < 3)
              split2.push(0);
            values[_i12] = Number(split2[0]) * 3600 + Number(split2[1]) * 60 + Number(split2[2]);
          }
          add("t");
          return this;
        },
    ...
    later.parse.text = function(string2) {
      ...
      function parseEvery(r) {
        ...
        if (checkAndParse(TOKENTYPES.weekend)) {
          ...
          number2 = parseTokenValue(TOKENTYPES.rank);
          r.every(number2);
          period = parseTimePeriod(r);
          if (checkAndParse(TOKENTYPES.start)) {
            number2 = parseTokenValue(TOKENTYPES.rank);
            r.startingOn(number2);
      ...
      return parseScheduleExpr(string2.toLowerCase());
    };
    function getOffset(date2, zone) {
      var d = date2.toLocaleString("en-US", {
        hour12: false,
        timeZone: zone,
        timeZoneName: "short"
      ...
      return date2.getTime() - zdate.getTime();
    }
    ...
    var humanInterval = (time) => {
      ...
      for (; ; ) {
        ...
        if (matchedNumber.length > 0) {
          number2 = Number.parseFloat(matchedNumber);
          if (Number.isNaN(number2)) {
            number2 = numbered.parse(matchedNumber);
          }
        }
...
// node_modules/.pnpm/bree@9.1.1/node_modules/bree/src/job-utils.js
var require_job_utils = __commonJS({
  "node_modules/.pnpm/bree@9.1.1/node_modules/bree/src/job-utils.js"(exports, module2) {
...
// node_modules/.pnpm/bree@9.1.1/node_modules/bree/src/job-builder.js
var require_job_builder = __commonJS({
  "node_modules/.pnpm/bree@9.1.1/node_modules/bree/src/job-builder.js"(exports, module2) {
    var { join } = require("path");
    var isSANB = require_lib();
    var isValidPath = require_is_valid_path();
    var later = require_lib2();
    var { boolean: boolean2 } = require_lib3();
    ...
    var buildJob = (job, config) => {
      ...
      if (typeof job.path === "function") {
        ...
        const path = isSANB(job.path) ? job.path : join(
          config.root,
  ...
  "node_modules/.pnpm/cron-validate@1.4.3/node_modules/cron-validate/lib/helper.js"(exports) {
    ...
    var checkSingleElementWithinLimits = (element, cronFieldType, options) => {
      ...
      if (lowerLimit && number2 < lowerLimit) {
        return result_1.err(`Number ${number2} of ${cronFieldType} field is smaller than lower limit '${lowerLimit}'`);
      }
      if (upperLimit && number2 > upperLimit) {
        return result_1.err(`Number ${number2} of ${cronFieldType} field is bigger than upper limit '${upperLimit}'`);
      }
      return result_1.valid(true);
    };
...
// node_modules/.pnpm/yup@0.32.9/node_modules/yup/es/util/printValue.js
...
// node_modules/.pnpm/yup@0.32.9/node_modules/yup/es/locale.js
...
// node_modules/.pnpm/yup@0.32.9/node_modules/yup/es/util/isSchema.js
...
// node_modules/.pnpm/yup@0.32.9/node_modules/yup/es/Condition.js
...
// node_modules/.pnpm/yup@0.32.9/node_modules/yup/es/util/toArray.js
...
// node_modules/.pnpm/yup@0.32.9/node_modules/yup/es/ValidationError.js
function _extends() {
...
// node_modules/.pnpm/yup@0.32.9/node_modules/yup/es/util/runTests.js
...
// node_modules/.pnpm/yup@0.32.9/node_modules/yup/es/Reference.js
...
// node_modules/.pnpm/yup@0.32.9/node_modules/yup/es/util/createValidation.js
function _extends2() {
...
// node_modules/.pnpm/yup@0.32.9/node_modules/yup/es/util/reach.js
...
// node_modules/.pnpm/yup@0.32.9/node_modules/yup/es/util/ReferenceSet.js
var ReferenceSet;
...
// node_modules/.pnpm/yup@0.32.9/node_modules/yup/es/schema.js
function _extends3() {
...
// node_modules/.pnpm/yup@0.32.9/node_modules/yup/es/mixed.js
function create2() {
  return new Mixed();
}
...
// node_modules/.pnpm/yup@0.32.9/node_modules/yup/es/util/isAbsent.js
...
// node_modules/.pnpm/yup@0.32.9/node_modules/yup/es/boolean.js
function create3() {
...
// node_modules/.pnpm/yup@0.32.9/node_modules/yup/es/string.js
function create4() {
...
// node_modules/.pnpm/yup@0.32.9/node_modules/yup/es/number.js
function create5() {
...
// node_modules/.pnpm/yup@0.32.9/node_modules/yup/es/util/isodate.js
...
// node_modules/.pnpm/yup@0.32.9/node_modules/yup/es/date.js
function create6() {
...
// node_modules/.pnpm/yup@0.32.9/node_modules/yup/es/util/sortFields.js
...
// node_modules/.pnpm/yup@0.32.9/node_modules/yup/es/util/sortByKeyOrder.js
...
// node_modules/.pnpm/yup@0.32.9/node_modules/yup/es/object.js
function _extends4() {
...
// node_modules/.pnpm/yup@0.32.9/node_modules/yup/es/array.js
function _extends5() {
...
// node_modules/.pnpm/yup@0.32.9/node_modules/yup/es/Lazy.js
...
// node_modules/.pnpm/yup@0.32.9/node_modules/yup/es/setLocale.js
...
// node_modules/.pnpm/yup@0.32.9/node_modules/yup/es/index.js
var es_exports = {};
__export(es_exports, {
...
var require_option = __commonJS({
  "node_modules/.pnpm/cron-validate@1.4.3/node_modules/cron-validate/lib/option.js"(exports) {
    ...
    var yup = __importStar((init_es(), __toCommonJS(es_exports)));
    init_es();
    var result_1 = require_result();
...
// node_modules/.pnpm/bree@9.1.1/node_modules/bree/src/job-validator.js
var require_job_validator = __commonJS({
  "node_modules/.pnpm/bree@9.1.1/node_modules/bree/src/job-validator.js"(exports, module2) {
    var fs = require("fs");
    var { join } = require("path");
    var combineErrors = require_combine_errors();
    var cron = require_lib4();
    var isSANB = require_lib();
    var isValidPath = require_is_valid_path();
...
// node_modules/.pnpm/bree@9.1.1/node_modules/bree/src/index.js
var require_src = __commonJS({
  "node_modules/.pnpm/bree@9.1.1/node_modules/bree/src/index.js"(exports, module2) {
    var fs = require("fs");
    ...
    var Bree2 = class extends EventEmitter {
      ...
      async run(name) {
        ...
        if (name) {
          ...
          this.workers.set(name, this.createWorker(job.path, object2));
...
var require_p_is_promise = __commonJS({
  "node_modules/.pnpm/p-is-promise@3.0.0/node_modules/p-is-promise/index.js"(exports, module2) {
    "use strict";
    var isObject2 = (value) => value !== null && (typeof value === "object" || typeof value === "function");
    module2.exports = (value) => value instanceof Promise || isObject2(value) && typeof value.then === "function" && typeof value.catch === "function";
  }
});
...
var require_delay = __commonJS({
  "node_modules/.pnpm/lil-http-terminator@1.2.2/node_modules/lil-http-terminator/src/delay.js"(exports, module2) {
    module2.exports = function delay(time) {
      return new Promise((resolve2) => setTimeout(() => resolve2(), time).unref());
    };
  }
});
...
// @packages/breectus/src/hooks/index.ts
var hooks_exports = {};
...
var hooks_default = defineHook(({ init }, { logger, env }) => {
  init("app.before", async ({ app }) => {
    const root = (0, import_path.resolve)(env.EXTENSIONS_PATH, "jobs");
